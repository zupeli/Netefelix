		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Projeto NeteFelix",
									"targetURL": "#projnetefelix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projnetefelix-display": {
								"semanticObject": "projnetefelix",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projnetefelix",
									"url": sap.ui.require.toUrl("projnetefelix")
								}
							}
						}
					}
